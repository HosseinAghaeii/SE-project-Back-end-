package ir.segroup.unipoll.config.security.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (null != jwt) {
            try {
                ...
                throw new SystemServiceException(ExceptionMessages.AUTHENTICATION_FAILED.getMessage(), HttpStatus.UNAUTHORIZED);
            }
        }
